...
/**
 * Die Service Klasse stellt die Verbindung zur Weinhandel Datenbank her. Sie
 * enthaelt die Methoden zum Ausfuehren der Datenoperationen die von der
...
public class Services {
	...
	private Object getobject(String cTablename) {
		...
		case "REGION":
			...
			return (Object) oRegion;
		case "REBSORTE":
			Rebsorte oRebsorte = new Rebsorte();
			return (Object) oRebsorte;
		case "TYP":
			Typ oTyp = new Typ();
			return (Object) oTyp;
		case "BENUTZER":
			Benutzer oUser = new Benutzer();
			return (Object) oUser;
		case "WEIN_REBSORTE":
			Wein_Rebsorte oWein_Rebsorte = new Wein_Rebsorte();
			return (Object) oWein_Rebsorte;
		}
		return null;
	}

	/**
	 * Finder Methode um SQL String auszufuehren. // - Funktion ueberprueft ob
	 * im Where Teil Delete etc uebergeben wurde, // dies fuehrt zum Fehler.
	 * 
	 * @param obj
	 *            Cast Object.
	 * @param cFilter
	 *            SQL Filter für Tabelle
	 ...
	 */
	private Object[] findObject(Object obj, String cFilter)
		...
		cSQL = getSQLStatement(cTablename);
	...
	private String getSQLStatement(String cTablename) {
		switch (cTablename.toUpperCase()) {
		case "WEIN":
			return global.gl_WeinSQL;
		case "WEINGUT":
			return global.gl_WeingutSQL;
		case "ART":
			return global.gl_ArtSQL;
		case "LAND":
			return global.gl_LandSQL;
		case "BENUTZER":
			return global.gl_BenutzerSQL;
		case "REGION":
			return global.gl_RegionSQL;
		case "REBSORTE":
			return global.gl_RebsorteSQL;
		case "TYP":
			return global.gl_TypSQL;
		case "WEIN_REBSORTE":
			return global.gl_Wein_Rebsorte;
		}
		return null;
	}
	 ...
	 * @throws InvocationTargetException
	 */
	public Art[] getArtTable(String cFilter) throws SQLException, IOException,
	 ...
	 * @throws InvocationTargetException
	 */
	public Land[] getLandTable(String cFilter) throws SQLException,
	 ...
	 * @throws InvocationTargetException
	 */
	public Rebsorte[] getRebsorteTable(String cFilter) throws SQLException,
			IOException, ClassNotFoundException, NoSuchFieldException,
			SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		Rebsorte oRebsorte = new Rebsorte();
	 ...
	 * 
	 * @param SQL
	 *            Filter für die Wein_Rebsortentabelle
	 ...
	 * @throws InvocationTargetException
	 */
	public Wein_Rebsorte[] getWein_RebsorteTable(String cFilter)
	 ...
	 * @throws InvocationTargetException
	 */
	public Region[] getRegionTable(String cFilter) throws SQLException,
			IOException, ClassNotFoundException, NoSuchFieldException,
			SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		Region oRegion = new Region();
	 ...
	 * @throws InvocationTargetException
	 */
	public Typ[] getTypTable(String cFilter) throws SQLException, IOException,
			ClassNotFoundException, NoSuchFieldException, SecurityException,
			IllegalAccessException, IllegalArgumentException,
			InvocationTargetException {
		Typ oTyp = new Typ();
	 ...
	 * @throws InvocationTargetException
	 */
	public Weingut[] getWeingutTable(String cFilter) throws SQLException,
			IOException, ClassNotFoundException, NoSuchFieldException,
			SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
		Weingut oWeingut = new Weingut();
	 ...
	 * @throws InvocationTargetException
	 */
	private Benutzer[] getBenutzer(String cFilter) throws SQLException,
			IOException, ClassNotFoundException, NoSuchFieldException,
			SecurityException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException {
	...
	/**
	 * Die Funktion stellt eine Verbindung zur Datenbank her // sendet den
	 * uebergebenen SQL String, wartet auf die Rueckgabe der Datenbank // und
	 * schliesst die Verbindung wieder.
	 * 
	 * @param cSQL
	 *            SQL Statement ohne Where Clause
	 * @param cFilter
	 ...
	 * @throws SQLException
	 */
	private ResultSet selectSQLStatement(String cSQL, String cFilter)
	...
	/**
	 * Die Funktion führt einen Insert SQL Statement auf der Weinhandeldatenbank
	 * aus
	 * 
	 * @param cSQL
	 ...
	 * @throws SQLException
	 */
	private void insertSQLStatement(String cSQL) throws ClassNotFoundException,
			SQLException {
		String url = ServerConnection.GetDBConnectionString();
		String user = ServerConnection.GetDBLoginUser();
		String userPw = ServerConnection.GetDBLoginPW();
	 ...
	 */
	public String addFilter(String m_cFilter, String cFieldname,
			String cFieldValue) {
	...
	/**
	 * Die Funtkion such in der Datenbank nach dem Benutzer und ueberprueft ob
	 ...
	 * @return
	 */
	public Wein stringToWeinDto(int nId, String cWeinname, int nArtId,
			int nTyp, String cBeschreibung, double nPreis, int nJahrgang) {
	...
	/**
	 * Die Funktion ueberprueft anhand der WeinID ob es den Wein bereits in der
	 * Datenbank gibt, wenn nicht wird dieser neu angelegt.
	 * 
	 * @param oWein
	 * @throws ClassNotFoundException
	 * @throws SQLException
	 */
	public void refreshWeintable(Wein oWein) throws ClassNotFoundException,
			SQLException {
	 ...
	 * 
	 */
	public void deleteWeinDS(Wein oWein) throws ClassNotFoundException,
			SQLException {
		String cSQL = "";
		cSQL = "DELETE FROM wein WHERE wein.nr = "
				+ String.valueOf(oWein.getWeinnummer());
	 ...
	 * @throws SQLException
	 */
	private void updateWein(Wein oWein) throws ClassNotFoundException,
			SQLException {
		String cSQL = "";
	...
	/**
	 * Die Funktion fuegt ueber dden SQL Insert Befehl einen neuen Datensatz
	 * hinzu
	 * 
	 * @param oWein
	 *            Wein DTO
	 ...
	 * @throws SQLException
	 */
	private void insertWein(Wein oWein) throws ClassNotFoundException,
			SQLException {
		String cSQL = "";
